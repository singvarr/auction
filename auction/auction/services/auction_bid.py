...
from auction.auction.exceptions import InvalidAuctionStatusException, InvalidBidValueException
...
class AuctionBidService:
    ...
    def create(self, data, user: User, auction: Auction) -> AuctionBid:
        ...
        if (
            (not latest_bid and value <= auction.lot.initial_price) or
        ...
        self._notification_service.send_notification_about_new_bid(bid=new_bid, socket_id=data["socket_id"])
